...
case class ProcessFileWithPromise(filePath: String, replyPromise: Promise[Processed]) extends Command
case class CalculateAverages(replyTo: ActorRef[AveragesCalculated]) extends Command
